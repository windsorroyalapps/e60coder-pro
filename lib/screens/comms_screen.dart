              ...
              return const Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text('Scanning communication channels…'),
                  ],
                ),
              );
            }
            ...
            if (groups.isEmpty) {
              return Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.device_hub, size: 48, color: Colors.grey[700]),
                    const SizedBox(height: 12),
                    const Text('No endpoints found'),
                    const SizedBox(height: 16),
                    OutlinedButton.icon(
                      onPressed: () => comms.refreshAll(),
                      icon: const Icon(Icons.refresh),
      ...
      child: ExpansionTile(
        ...
        trailing: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: _stateColor(e.state).withOpacity(0.6)),
          ),
